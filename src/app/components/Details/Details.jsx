...
const Details = () => {
    ...
    <main className="container_details">
        <SectionDetail 
            ...
            text="Après une formation fullstack, je suis à la recherche de la première entreprise qui me fera confiance. L'occasion pour vous de tailler dans le marbre votre vision du clean clode. Ma curiosité et ma soif d'apprentissage vont me permettre de m'intégrer rapidement à votre entreprise."
